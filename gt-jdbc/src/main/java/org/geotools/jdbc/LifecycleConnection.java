...
/**
 * Calls the {@link ConnectionLifecycleListener#onBorrow(Connection)} method on construction and makes sure the
 * {@link ConnectionLifecycleListener#onRelease(Connection)} is called when this connection is closed (the assumption is
 * that the wrapped connection is pooled, as such on "close" it will actually be returned to the pool)
 *
