...
public final class SDO {
     ...
     */
    private static void elemInfo(List elemInfoList, Geometry geom, final int STARTING_OFFSET, final int GTYPE) {
    ...
    private static void addElemInfo(List elemInfoList, Polygon polygon, final int STARTING_OFFSET, final int GTYPE) {
    ...
    private static void addElemInfo(List elemInfoList, MultiPolygon polys, final int STARTING_OFFSET, final int GTYPE) {
        Polygon poly;
        int offset = STARTING_OFFSET;
    ...
    /**
     * Produce <code>SDO_ETYPE</code> for geometry description as stored in the <code>SDO_ELEM_INFO</code>.
     *
     ...
     *
     * <ul>
     *   <li><code>simple</code> elements are defined by a single triplet entry in the <code>SDO_ELEM_INFO</code> array
    ...
    /**
     * Produce <code>SDO_INTERPRETATION</code> for geometry description as stored in the <code>SDO_ELEM_INFO</code>.
     *
    ...
    */
    ...
    public static CoordinateSequence coordinates(CoordinateSequenceFactory f, final int GTYPE, double[] ordinates) {
        ...
        final int LEN =
                D; // bugfix 20121231-BK: LEN = D instead of LEN = D + L as Oracle supports only one LRS ordinate!
        ...
        if (L != 0) {
            ...
            // TODO org.geotools.geometry.jts.CoordinateSequenceFactory does not support 4 dimensions - thus we will get
            // only 3 dimensions!
     ...
     *     {@link SDO#coordiantes(CoordinateSequenceFactory, OrdinateList, OrdinateList, OrdinateList, OrdinateList)
     *     coordiantes() with just a OrdinateList of measures}! Construct SpatialCoordinates, with LRS measure
     *     information.
     *     <p>To produce two dimension Coordinates pass in <code>null</code> for z
     * @param f DOCUMENT ME!
     * @param x x-ordinates
    ...
    @Deprecated
    public static CoordinateSequence coordiantes(
            CoordinateSequenceFactory f, AttributeList x, AttributeList y, AttributeList z, AttributeList[] m) {
        final int D = (z != null) ? 3 : 2;
        final int L = (m != null) ? m.length : 0;
    ...
    private static LineString createLine(
        ...
        if (etype == ETYPE.LINE && INTERPRETATION == 1) {
            ...
            throw new IllegalArgumentException("ELEM_INFO ETYPE " + etype + " with INTERPRETAION " + INTERPRETATION
     ...
     * </ul>
     *
     * <p>The polygon encoding will process subsequent 2003, or 3 triples with clockwise ordering as interior holes.
     *
    ...
    private static MultiLineString createMultiLine(
        ...
        if (!(INTERPRETATION == 1)) {
            ...
            LOGGER.warning("Could not create MultiLineString with INTERPRETATION " + INTERPRETATION
