...
public class GeometryConverter {
     ...
     *
     * <p>Compare and contrast with toORDINATE - which treats <code>Double.NaN</code> as<code>NULL</code>
     */
     ...
     * Convience method for ARRAY construction.
     *
     * <p>Forced to burn memory here - only way to actually place <code>NULL</code> numbers in the ordinate stream.
     *
     * <ul>
     ...
     * </ul>
     *
     * <p>The alternative is to construct the array from a array of doubles, which does not record <code>NULL</code>
     * NUMBERs.
     *
     ...
     */
    protected final ARRAY toORDINATE(CoordinateList list, double measures[][], final int D) throws SQLException {
